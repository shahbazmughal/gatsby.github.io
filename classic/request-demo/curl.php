...
$pagecontents = str_replace("%%fullname%%" , $_POST["firstname"] . " " . $_POST["lastname"] , $pagecontents);
...
try { 
    ...
    $params = [
        ...
        'full_name'         =>  isset($_POST['firstname']) ? $_POST["firstname"] . " " . $_POST["lastname"] : "",
