...
$pagecontents = str_replace("%%fullname%%" , $_POST["fullname"] , $pagecontents);
$pagecontents = str_replace("%%email%%" , $_POST["email"] , $pagecontents);
$pagecontents = str_replace("%%phoneno%%" , $_POST["phoneno"] , $pagecontents);
$pagecontents = str_replace("%%subject%%" , $_POST["subject"] , $pagecontents);
...
$post = $_POST;
    ...
    $data = [
        'personalizations' => [[
            ...
            'send_at' => $time,
            'subject' => "Mumara Contact us Form"
        ]
        ],
        'content' => [
            [
